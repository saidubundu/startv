...
else
{
    ...
    public function destroy($id)
    {
        ...
        return redirect("/backend/blog")->with('trash-message', ['Your post was moved to Trash successfully!', $id]);
    }
    ...
    public function restore($id)
    {
        ...
        return redirect()->back()->with('message', 'Your post has been moved from trash successfully!');
    }
